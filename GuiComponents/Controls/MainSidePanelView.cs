...
namespace GuiComponents.Controls
{
    public partial class MainSidePanelView : UserControl, IMainSidePanelView
    {
        ...
        public event EventHandler ReloadAccuracyBrackets;
        ...
        public MainSidePanelView()
        {
            ...
            button_reloadAccuracyBrackets.Click += delegate { onReloadAccuracyBrackets(); };
        }
        ...
        protected virtual void onReloadAccuracyBrackets()
        {
            ReloadAccuracyBrackets?.Invoke(this, EventArgs.Empty);
        }
    }
}
